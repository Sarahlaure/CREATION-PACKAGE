...
produit_path = "E:/ISEP 2/MON DOSSIER/SEMESTRE 2/TRAITEMENTS STATISTIQUES AVEC R/Createpack/database
/fruits.dta"
conversion_path = "E:/ISEP 2/MON DOSSIER/SEMESTRE 2/TRAITEMENTS STATISTIQUES AVEC R/Createpack/database
/Table_de_conversion_phase_2.xlsx"
produit = "fruits"
